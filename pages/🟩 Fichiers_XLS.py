...
#############################################
st.markdown(f'<h1 style="background-color:{main_color};border-radius:14px;text-align:center;">{"ANALYSE : PROFIL FORCE-VITESSE | XLS"}</h1>', unsafe_allow_html=True)
# f'*version 2.10 - par Corentin Casali*'
f"""Vous êtes actuellement sur la page concernant les **fichiers .xls**. Si vous utilisez les **fichiers .tdms**, merci de changer de page."""
